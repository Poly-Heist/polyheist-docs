...
Please read this End-User License Agreement carefully before clicking the "I Agree" button, downloading or using PolyHeist - Heist.
...
* **Application** means the software program provided by the Company downloaded by You to a Device, named PolyHeist - Heist
* **Company** \(referred to as either "the Company", "We", "Us" or "Our" in this Agreement\) refers to PolyHeist Inc, Hobujaama, Tallinn, 10151.
